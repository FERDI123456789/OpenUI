...
export default function ComponentPanel({
  ...
  return (
    <>
      <div
        className={`fixed inset-0 bg-black/20 w-full backdrop-blur-sm z-40 transition-all duration-500 ease-out ${
      ...
      <div
        className={`fixed top-0 right-0 h-full w-[85%] bg-linear-to-br from-gray-900 via-gray-900 to-purple-900/20 backdrop-blur-md shadow-2xl shadow-purple-900/30 z-50 component-panel rounded-l-3xl ${
          panelVisible
