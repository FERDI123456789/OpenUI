      ...
      <div className="text-center relative z-10 w-full mb-20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            className="bg-purple-600 text-white px-8 py-4 rounded-full font-medium hover:bg-purple-500 transition-all duration-300 text-sm shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 hover:scale-105"
          >
            Start for free
          </button>
        </div>
      ...
      {publicComponents === undefined ? (
        ...
        <div className="relative z-10 mt-40">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif text-white mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
              Entdecke unsere <span className="text-purple-400">Komponenten</span>
            </h2>
